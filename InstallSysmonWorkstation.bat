...
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/benmckinzie/sysmon/master/workstation_sysmonconfig.xml','C:\ProgramData\sysmon\sysmonconfig-export.xml')"
