...
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/benmckinzie/sysmontest/master/servers_sysmonconfig.xml','C:\ProgramData\sysmon\sysmonconfig-export.xml')"
